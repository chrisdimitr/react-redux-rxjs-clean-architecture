...
import SearchInput from "@shared/components/search-input/SearchInput.tsx";

import styles from "./EnterpriseList.module.scss";
import EnterpriseListHook from "./EnterpriseListHook.ts";
import { EnterpriseListPropsModel } from "./EnterpriseListModel.ts";
...
const CreateEditSiteForm = lazy(
  () => import("../../../../../site-overview/adapters/in/components/CreateEditSiteForm/CreateEditSiteForm.tsx")
);
...
const EnterpriseList = (props: EnterpriseListPropsModel) => {
  const { enterprises, onCreateEnterprise } = props;
  ...
  const {
    ...
    openSiteForm,
    handleCloseSiteForm
  } = EnterpriseListHook(onCreateEnterprise);
